...
function Item(props: ItemProps) {
  ...
  const [priorinput, setPriorinput]: any = useState(props.priority)
  ...
  return (
    <div className={searched.current ? 'student searched' : 'student'}>
      ...
      <div className="inputcont">
        ...
        <input name='prior' onFocus={(e) => handleFocus(e)} onBlur={(e) => handleBlur(e, props.id)} onChange={(e) => handleCounter(e, props.id)} value={priorinput} className='priorinput' type="number"/>
